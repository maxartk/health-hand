...
@JsonClass(generateAdapter = true) data class AutomationEvent(val event_id:String="",val event_name:String="",val status:String="pending",val attempts:Int=0,val last_error:String?=null,val created_at:Long=0,val updated_at:Long=0,val delivered_at:Long?=null,val next_attempt_at:Long=0)
